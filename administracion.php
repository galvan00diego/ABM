		...
		foreach ($ArrayDeProductos as $prod){
			...
			// 				<td><img src='archivos/".$prod->GetPathFoto()."' width='100px' height='100px'/></td>";
			 $grilla .= "<tr>
							...
							<td rowspan=2>".$prod->getCodBarra()."</td>
							<td rowspan=2>".$prod->getNombre()."</td>
							<td rowspan=2><img src='archivos/".$prod->getPathFoto()."' width='100px' height='100px'/></td>";
			$grilla.= '<td><input type="button" value="Eliminar" onclick="Main.EliminarProducto('.$prod->getCodBarra().')"></tr><td><input type="button" value="Modificar" onclick="Main.ModificarProducto('.$prod->getCodBarra().')"></td>';
